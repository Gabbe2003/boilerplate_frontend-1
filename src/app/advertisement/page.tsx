  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setStatus('error');
        setGlobalError(responseBody?.message || 'Submission failed. Please try again.');
      }
          ...
          <div>
            <div className="flex items-center gap-2 mb-3 text-indigo-700 font-semibold">
              ...
              <span className="text-lg">
                {process.env.NEXT_PUBLIC_HOSTNAME || 'Our Site'} Article Pricing
              </span>
            </div>
            <ul className="space-y-2 text-gray-700 text-base ml-1">
              <li className="flex items-center gap-2">
                ...
                <span>
                  <strong>€350</strong> per article <span className="text-gray-500">(General Content)</span>
                  <br />
              ...
              <li className="flex items-center gap-2">
                ...
                <span>
                  <strong>€550</strong> per article <span className="text-gray-500">(Crypto, Forex, Loans &amp; Finance)</span>
                  <br />
                  <span className="text-xs text-gray-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>
                  <strong>€700</strong> per article <span className="text-gray-500">(Casino, Betting &amp; Gambling)</span>
                  <br />
                  <span className="text-xs text-gray-400">
            ...
            <div className="mt-4 text-sm text-gray-600">
              <strong>Discounts:</strong> Bundle orders of <span className="font-semibold">3+ articles</span> get reduced pricing. <br />
          ...
          <div className="flex flex-col gap-3 w-full mt-6">
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg px-4 py-3">
              ...
              <ul className="list-disc list-inside text-gray-700 text-sm space-y-1 pl-1">
                ...
                <li>All articles are <span className="font-semibold">published permanently</span> on {process.env.NEXT_PUBLIC_HOSTNAME || 'our site'}.</li>
                <li>
                  No “sponsored” tag in article text.<br />
                  <span className="text-gray-400">A small sponsorship indication appears on the cover image, per Swedish law (does not affect links).</span>
                </li>
              </ul>
            </div>
            ...
            <div className="mt-2 text-gray-500 text-xs">
              For bulk order discounts or further inquiries,<br />
              <a
              ...
              <div className="bg-gradient-to-br from-yellow-50 via-indigo-50 to-white border-2 border-yellow-400 shadow-lg rounded-xl px-5 py-4 flex flex-col sm:flex-row items-center gap-4 text-indigo-900 ring-2 ring-yellow-200">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <span className="text-sm text-indigo-900 font-semibold mb-1">
                    Get featured in our exclusive newsletter to <span className="text-yellow-700 font-extrabold">20,000+</span> engaged subscribers!
                  </span>
                  <span className="text-base">
                    <span className="font-semibold text-indigo-700">Want to be in our newsletter?</span><br />
                    <span className="font-bold text-yellow-700">Contact us for a special offer on {process.env.NEXT_PUBLIC_HOSTNAME || 'our site'}!</span>
                  </span>
                </div>
              </div>
            </div>
