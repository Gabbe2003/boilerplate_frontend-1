        ...
        <aside className="md:col-span-3 flex flex-col gap-6 order-2 md:order-3">
          <div>
            ...
            <div className="flex flex-col ">
              {post_right.map((post: any, index: number) => (
                <div key={post.id}>
                  ...
                  {post && (
                    <Link
                      ...
                      className="
                        group 
                        flex flex-col [@media(min-width:1271px)]:flex-row
                        gap-3 
                        py-4 
                        border-b
                      "
                    >
                      <div
                        className="
                          relative 
                          w-full [@media(min-width:1271px)]:w-28 
                          aspect-[5/3]
                          overflow-hidden 
                          bg-[#f7f1ea]
                        "
                  ...
                  {/* Inject ReadPeak BETWEEN index 0–4 (e.g., after index 4) */}
                  {index === 2 && (
                    <div className="my-4 ">
                      <ReadPeak  />
                    </div>
