...
<div className="flex flex-wrap items-center justify-between mt-6 gap-2 pt-2">
  ...
  <span className="text-sm text-muted-foreground flex items-center">
    By <span className="ml-1 font-medium">{post.author?.node.name || "Redaktionen"}</span>
  </span>

  {/* Social Media */}
  <div className="flex items-center gap-2">
    <span className="text-sm text-muted-foreground">Dela</span>
    <Button variant="ghost" size="iconSmall" className="text-gray-600 hover:text-gray-800">
...
{post.featuredImage?.node.sourceUrl && (
  <CardContent className="p-0">
    ...
    <p className="text-muted-foreground text-[10px] mb-4">{post.title}</p>
